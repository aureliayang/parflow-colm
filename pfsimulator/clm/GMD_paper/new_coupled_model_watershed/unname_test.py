...
CONCN.Process.Topology.P = 4
CONCN.Process.Topology.Q = 3
...
# ip = 'unname_test.out.press.00060.pfb'
ip = './initial_press/unname_test.out.press.00548.pfb'
...
CONCN.Geom.indi_input.FileName = 'unname.subsur11.pfb'
...
CONCN.dist('unname.subsur11.pfb')
#CONCN.dist(ip)
...
# CONCN.Solver.CLM.MetFileName       = 'E5L'
# CONCN.Solver.CLM.MetFilePath       = '../E5L/' 
...
CONCN.Solver.RelTol = 1e-5
CONCN.Solver.MaxConvergenceFailures = 500
